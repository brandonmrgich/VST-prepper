...
class TransientDetector:
    ...
    def detect_transients(self, audio, sr, threshold=0.05, min_distance=1.0, hop_length=512):
    ...
    def process_transients(self, audio, sr, transients, output_dir, normalizer, frame_offset=0.090):
        """
        ...
        for i, start_time in enumerate(transients):
            ...
            note_name = note_identifier.identify_note_and_name(audio[int(adjusted_start_time * sr):int(end_time * sr)], sr)
