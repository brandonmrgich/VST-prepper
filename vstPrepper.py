...
parser = argparse.ArgumentParser(description="Process audio files with transient detection and normalization.")
parser.add_argument("input_audio_files", nargs='+', help="List of input audio files or directories containing audio files.")
parser.add_argument("output_directory", help="Directory to save the processed audio files.")
